...
class Api
{
     ...
     * @return Bot
     */
    public function sendDocument(int|string $chat_id, string $document, string|null $caption = '', string|null $thumbnail = null, int|null $message_thread_id = 0, string|null $parse_mode = '', ?string $caption_entities = null, bool|null $disable_content_type_detection = false, bool|null $disable_notification = false, bool|null $protect_content = false, int|null $reply_to_message_id = 0, bool|null $allow_sending_without_reply = false, array|string|null $reply_markup = ''): Bot
    {
     ...
     * @return Bot
     */
    public function answerCallbackQuery(string $callback_query_id,string $text,bool $show_alert = true,string $url = '',int $cache_time = 0): Bot
    {
        return $this->call(['callback_query_id' => $callback_query_id,'text' => $text,'show_alert' => $show_alert,'url' => $url,'cache_time' => $cache_time], __FUNCTION__);
    }
    /**
