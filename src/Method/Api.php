...
class Api
{
     ...
     * @param array<string>|null $allowed_updates Optional. A list of update types the bot is subscribed to. Defaults to all update types except chat_member

     * @return Bot
     */
    public function getWebhookInfo(string $url, bool $has_custom_certificate, int $pending_update_count, string|null $ip_address = '', int|null $last_error_date = 0, string|null $last_error_message = '', int|null $last_synchronization_error_date = 0, int|null $max_connections = 0, ?array $allowed_updates = []): Bot
    {
     ...
     * @return Bot
     */
    public function UserProfilePhotos(int $total_count, ?array $photos = []): Bot
    {
     ...
     * @return Bot
     */
    public function ReplyKeyboardMarkup(?array $keyboard = [], bool|null $is_persistent = false, bool|null $resize_keyboard = false, bool|null $one_time_keyboard = false, string|null $input_field_placeholder = '', bool|null $selective = false): Bot
    {
     ...
     * @return Bot
     */
    public function InputMediaVideo(string $type, string $media, string|null $thumbnail, string|null $caption = '', string|null $parse_mode = '', ?array $caption_entities = [], int|null $width = 0, int|null $height = 0, int|null $duration = 0, bool|null $supports_streaming = false, bool|null $has_spoiler = false): Bot
    {
     ...
     * @return Bot
     */
    public function InputMediaAnimation(string $type, string $media, string|null $thumbnail, string|null $caption = '', string|null $parse_mode = '', ?array $caption_entities = [], int|null $width = 0, int|null $height = 0, int|null $duration = 0, bool|null $has_spoiler = false): Bot
    {
     ...
     * @return Bot
     */
    public function InputMediaAudio(string $type, string $media, string|null $thumbnail, string|null $caption = '', string|null $parse_mode = '', ?array $caption_entities = [], int|null $duration = 0, string|null $performer = '', string|null $title = ''): Bot
    {
     ...
     * @return Bot
     */
    public function InputMediaDocument(string $type, string $media, string|null $thumbnail, string|null $caption = '', string|null $parse_mode = '', ?array $caption_entities = [], bool|null $disable_content_type_detection = false): Bot
    {
     ...
     * @return Bot
     */
    public function copyMessage(int|string $chat_id, int|null $message_thread_id = 0, int|string $from_chat_id, int $message_id, string|null $caption = '', string|null $parse_mode = '', ?array $caption_entities = [], bool|null $disable_notification = false, bool|null $protect_content = false, int|null $reply_to_message_id = 0, bool|null $allow_sending_without_reply = false, array|string|null $reply_markup): Bot
    {
     ...
     * @return Bot
     */
    public function sendPhoto(int|string $chat_id, int|null $message_thread_id = 0, string $photo, string|null $caption = '', string|null $parse_mode = '', ?array $caption_entities = [], bool|null $has_spoiler = false, bool|null $disable_notification = false, bool|null $protect_content = false, int|null $reply_to_message_id = 0, bool|null $allow_sending_without_reply = false, array|string|null $reply_markup): Bot
    {
     ...
     * @return Bot
     */
    public function sendAudio(int|string $chat_id, int|null $message_thread_id = 0, string $audio, string|null $caption = '', string|null $parse_mode = '', ?array $caption_entities = [], int|null $duration = 0, string|null $performer = '', string|null $title = '', string|null $thumbnail, bool|null $disable_notification = false, bool|null $protect_content = false, int|null $reply_to_message_id = 0, bool|null $allow_sending_without_reply = false, array|string|null $reply_markup): Bot
    {
     ...
     * @return Bot
     */
    public function sendDocument(int|string $chat_id, int|null $message_thread_id = 0, string $document, string|null $thumbnail, string|null $caption = '', string|null $parse_mode = '', ?array $caption_entities = [], bool|null $disable_content_type_detection = false, bool|null $disable_notification = false, bool|null $protect_content = false, int|null $reply_to_message_id = 0, bool|null $allow_sending_without_reply = false, array|string|null $reply_markup): Bot
    {
     ...
     * @return Bot
     */
    public function sendVideo(int|string $chat_id, int|null $message_thread_id = 0, string $video, int|null $duration = 0, int|null $width = 0, int|null $height = 0, string|null $thumbnail, string|null $caption = '', string|null $parse_mode = '', ?array $caption_entities = [], bool|null $has_spoiler = false, bool|null $supports_streaming = false, bool|null $disable_notification = false, bool|null $protect_content = false, int|null $reply_to_message_id = 0, bool|null $allow_sending_without_reply = false, array|string|null $reply_markup): Bot
    {
     ...
     * @return Bot
     */
    public function sendAnimation(int|string $chat_id, int|null $message_thread_id = 0, string $animation, int|null $duration = 0, int|null $width = 0, int|null $height = 0, string|null $thumbnail, string|null $caption = '', string|null $parse_mode = '', ?array $caption_entities = [], bool|null $has_spoiler = false, bool|null $disable_notification = false, bool|null $protect_content = false, int|null $reply_to_message_id = 0, bool|null $allow_sending_without_reply = false, array|string|null $reply_markup): Bot
    {
     ...
     * @return Bot
     */
    public function sendVoice(int|string $chat_id, int|null $message_thread_id = 0, string $voice, string|null $caption = '', string|null $parse_mode = '', ?array $caption_entities = [], int|null $duration = 0, bool|null $disable_notification = false, bool|null $protect_content = false, int|null $reply_to_message_id = 0, bool|null $allow_sending_without_reply = false, array|string|null $reply_markup): Bot
    {
     ...
     * @return Bot
     */
    public function sendVideoNote(int|string $chat_id, int|null $message_thread_id = 0, string $video_note, int|null $duration = 0, int|null $length = 0, string|null $thumbnail, bool|null $disable_notification = false, bool|null $protect_content = false, int|null $reply_to_message_id = 0, bool|null $allow_sending_without_reply = false, array|string|null $reply_markup): Bot
    {
     ...
     * @param int|string $chat_id YesUnique identifier for the target chat or username of the target channel (in the format @channelusername)
     * @param int|null $message_thread_id OptionalUnique identifier for the target message thread (topic) of the forum; for forum supergroups only
     * @param array<InputMediaAudio, InputMediaDocument, InputMediaPhoto and InputMediaVideo> $media YesA JSON-serialized array describing messages to be sent, must include 2-10 items
     ...
     * @return Bot
     */
    public function sendMediaGroup(int|string $chat_id, int|null $message_thread_id = 0, ?array $media = [], bool|null $disable_notification = false, bool|null $protect_content = false, int|null $reply_to_message_id = 0, bool|null $allow_sending_without_reply = false): Bot
    {
     ...
     * @return Bot
     */
    public function sendLocation(int|string $chat_id, int|null $message_thread_id = 0, float $latitude, float $longitude, float|null $horizontal_accuracy, int|null $live_period = 0, int|null $heading = 0, int|null $proximity_alert_radius = 0, bool|null $disable_notification = false, bool|null $protect_content = false, int|null $reply_to_message_id = 0, bool|null $allow_sending_without_reply = false, array|string|null $reply_markup): Bot
    {
     ...
     * @return Bot
     */
    public function sendVenue(int|string $chat_id, int|null $message_thread_id = 0, float $latitude, float $longitude, string $title, string $address, string|null $foursquare_id = '', string|null $foursquare_type = '', string|null $google_place_id = '', string|null $google_place_type = '', bool|null $disable_notification = false, bool|null $protect_content = false, int|null $reply_to_message_id = 0, bool|null $allow_sending_without_reply = false, array|string|null $reply_markup): Bot
    {
     ...
     * @return Bot
     */
    public function sendContact(int|string $chat_id, int|null $message_thread_id = 0, string $phone_number, string $first_name, string|null $last_name = '', string|null $vcard = '', bool|null $disable_notification = false, bool|null $protect_content = false, int|null $reply_to_message_id = 0, bool|null $allow_sending_without_reply = false, array|string|null $reply_markup): Bot
    {
     ...
     * @param array<string> $options YesA JSON-serialized list of answer options, 2-10 strings 1-100 characters each
     ...
     * @return Bot
     */
    public function sendPoll(int|string $chat_id, int|null $message_thread_id = 0, string $question, ?array $options = [], bool|null $is_anonymous = false, string|null $type = '', bool|null $allows_multiple_answers = false, int|null $correct_option_id = 0, string|null $explanation = '', string|null $explanation_parse_mode = '', ?array $explanation_entities = [], int|null $open_period = 0, int|null $close_date = 0, bool|null $is_closed = false, bool|null $disable_notification = false, bool|null $protect_content = false, int|null $reply_to_message_id = 0, bool|null $allow_sending_without_reply = false, array|string|null $reply_markup): Bot
    {
     ...
     * @return Bot
     */
    public function sendChatAction(int|string $chat_id, int|null $message_thread_id = 0, string $action): Bot
    {
     ...
     * @return Bot
     */
    public function editMessageCaption(int|string|null $chat_id, int|null $message_id = 0, string|null $inline_message_id = '', string|null $caption = '', string|null $parse_mode = '', ?array $caption_entities = [], array|string|null $reply_markup): Bot
    {
     ...
     * @return Bot
     */
    public function editMessageLiveLocation(int|string|null $chat_id, int|null $message_id = 0, string|null $inline_message_id = '', float $latitude, float $longitude, float|null $horizontal_accuracy, int|null $heading = 0, int|null $proximity_alert_radius = 0, array|string|null $reply_markup): Bot
    {
     ...
     * @return Bot
     */
    public function sendSticker(int|string $chat_id, int|null $message_thread_id = 0, string $sticker, string|null $emoji = '', bool|null $disable_notification = false, bool|null $protect_content = false, int|null $reply_to_message_id = 0, bool|null $allow_sending_without_reply = false, array|string|null $reply_markup): Bot
    {
     ...
     * @param array<string> $custom_emoji_ids YesList of custom emoji identifiers. At most 200 custom emoji identifiers can be specified.

     * @return Bot
     */
    public function getCustomEmojiStickers(?array $custom_emoji_ids = []): Bot
    {
     ...
     * @return Bot
     */
    public function createNewStickerSet(int $user_id, string $name, string $title, ?array $stickers = [], string $sticker_format, string|null $sticker_type = '', bool|null $needs_repainting = false): Bot
    {
     ...
     * @param string $sticker YesFile identifier of the sticker
     * @param array<string> $emoji_list YesA JSON-serialized list of 1-20 emoji associated with the sticker

     * @return Bot
     */
    public function setStickerEmojiList(string $sticker, ?array $emoji_list = []): Bot
    {
     ...
     * @param string $sticker YesFile identifier of the sticker
     * @param array<string>|null $keywords OptionalA JSON-serialized list of 0-20 search keywords for the sticker with total length of up to 64 characters

     * @return Bot
     */
    public function setStickerKeywords(string $sticker, ?array $keywords = []): Bot
    {
     ...
     * @return Bot
     */
    public function InputMessageContent(string $message_text, string|null $parse_mode = '', ?array $entities = [], bool|null $disable_web_page_preview = false): Bot
    {
     ...
     * @return Bot
     */
    public function answerShippingQuery(string $shipping_query_id, bool $ok, ?array $shipping_options = [], string|null $error_message = ''): Bot
    {
     ...
     * @return Bot
     */
    public function ShippingOption(string $id, string $title, ?array $prices = []): Bot
    {
     ...
     * @return Bot
     */
    public function setPassportDataErrors(int $user_id, ?array $errors = []): Bot
    {
     ...
     * @param string $type The section of the user's Telegram Passport which has the issue, one of “utility_bill”, “bank_statement”, “rental_agreement”, “passport_registration”, “temporary_registration”
     * @param array<string> $file_hashes List of base64-encoded file hashes
     * @param string $message Error message

     * @return Bot
     */
    public function PassportElementErrorFiles(string $source, string $type, ?array $file_hashes = [], string $message): Bot
    {
     ...
     * @return Bot
     */
    public function PassportElementErrorTranslationFiles(string $source, string $type, ?array $file_hashes = [], string $message): Bot
    {
        return $this->call(['source' => $source, 'type' => $type, 'file_hashes' => $file_hashes, 'message' => $message,], __FUNCTION__);
    }
    /**
     ...
     * @return Bot
     */
    public function sendGame(int $chat_id, int|null $message_thread_id = 0, string $game_short_name, bool|null $disable_notification = false, bool|null $protect_content = false, int|null $reply_to_message_id = 0, bool|null $allow_sending_without_reply = false, array|string|null $reply_markup): Bot
    {
